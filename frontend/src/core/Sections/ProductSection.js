            ...
            <GridContainer justify="center">
                <GridItem xs={12} sm={12} md={8}>
                    ...
                    <h5 className={classes.description}>
                        AndSold: Make more of your things! AndSold is a platforms for people seeking the curiosities of
                        conventional
                        garage sales, all while saving the time, effort and risk of going outside. Sellers and potential
                        buyers get
